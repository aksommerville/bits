...
tests_CFILES_UNIT:=$(filter src/test/unit/%.c,$(CFILES))
tests_OFILES_UNIT:=$(patsubst src/%.c,$(tests_MIDDIR)/%.o,$(test_CFILES_UNIT))
...
tests_OFILES_INT:=$(patsubst src/%.c,$(tests_MIDDIR)/%.o,$(tests_CFILES_INT))
