...
void simplifio_video_get_size(int *w,int *h) {
  ...
  #endif
  #if USE_bcm
    if (simplifio.bcm) { bcm_get_size(w,h,simplifio.bcm); return; }
  #endif
  #if USE_macwm
...
int simplifio_video_describe_fb(struct simplifio_fb_description *desc) {
  ...
  #endif
  #if USE_bcm
    if (simplifio.bcm) return -1;//TODO
  #endif
  #if USE_macwm
...
void *simplifio_video_begin_fb() {
  ...
  #endif
  #if USE_bcm
    if (simplifio.bcm) return bcm_fb_begin(simplifio.bcm);
  #endif
  #if USE_macwm
...
int simplifio_video_end_fb() {
  ...
  #endif
  #if USE_bcm
    if (simplifio.bcm) return bcm_fb_end(simplifio.bcm);
  #endif
  #if USE_macwm
...
int simplifio_video_begin_gx() {
  ...
  #endif
  #if USE_bcm
    if (simplifio.bcm) return bcm_gx_begin(simplifio.bcm);
  #endif
  #if USE_macwm
...
int simplifio_video_end_gx() {
  ...
  #endif
  #if USE_bcm
    if (simplifio.bcm) return bcm_gx_end(simplifio.bcm);
  #endif
  #if USE_macwm
